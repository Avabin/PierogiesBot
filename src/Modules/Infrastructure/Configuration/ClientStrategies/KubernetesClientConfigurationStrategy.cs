...
public class KubernetesClientConfigurationStrategy : ClientConfigurationStrategyBase
{
    private readonly string _clusterId;
    private readonly string _connectionString;
    private readonly string _serviceId;

    public KubernetesClientConfigurationStrategy(string clusterId, string serviceId, string? connectionString)
    {

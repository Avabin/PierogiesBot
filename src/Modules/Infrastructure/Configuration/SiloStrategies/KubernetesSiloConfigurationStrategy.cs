...
public class KubernetesSiloConfigurationStrategy : SiloConfigurationStrategyBase
{
    ...
    public KubernetesSiloConfigurationStrategy(int siloPort, string clusterId, string serviceId,
